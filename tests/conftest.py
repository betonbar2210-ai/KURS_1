...
def test_read_ex():
    return pd.DataFrame(
        {
            "Дата платежа": ["2024-10-01", "2024-10-02"],
            "Сумма операции": [-100, 200],
            "Категория": ["Супермаркеты", "Кафе"],
            "Описание": ["Магнит", "Пятерочка"],
...
def testing_pd():
    return pd.DataFrame(
        {
            "Дата операции": ["15.10.2020 10:00:00", "05.11.2020 09:15:00", "25.12.2025 09:15:00"],
